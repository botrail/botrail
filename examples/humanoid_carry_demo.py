...
`examples/biped_test.urdf`, with no download — that is what the tests use.
...
Run with:  python examples/humanoid_carry_demo.py [out.usdc] [--robot g1|biped] [--studio]
"""
...
def walker_of(robot: str):
    ...
    if robot == "biped":
        return (bt.Robot.from_urdf(EXAMPLES / "biped_test.urdf"), bt.Gait(**BIPED_GAIT),
