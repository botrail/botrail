...
every step a lane on the timing chart.
    ...
    python examples/lift_demo.py            # bake + USD
    python examples/lift_demo.py --studio   # watch the ride
"""
...
def build(*, skip_door: bool = False) -> bt.Scene:
    scene = bt.Scene(bt.Robot.from_urdf(HERE / "simple_arm.urdf"), name="amr_lift")
