...
Run with:  python examples/painting/painting_hood_demo.py [--studio]
"""
...
GUN_URDF = Path(__file__).parents[1] / "assets" / "spray_gun.urdf"
...
def build_scene(mesh_dir: Path | None = None) -> tuple[bt.Scene, str]:
    ...
    mesh_dir = mesh_dir or Path(__file__).parents[1] / "assets"
