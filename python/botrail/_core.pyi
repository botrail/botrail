...
class Scene:
    @property
    def mounting_revalidation(self) -> list[str]: ...
    def _mounting_preview(self, candidate: Robot, robot: str | None = None) -> tuple[Scene, str]: ...
    def _mounting_apply(self, candidate: Robot, base_revision: str, candidate_revision: str, robot: str | None = None) -> None: ...
    def _mounting_report_json(self) -> str: ...
    def __init__(
        self,
...
def _connection_compatibility_json(manifest: str, host: str, selection: str) -> str: ...
