 ...
 */
robot: string | null, segment: SegmentMsg, } | { "type": "remove_segment", motion: string, index: number, } | { "type": "clear_motion", motion: string, } | { "type": "plan_motion", motion: string, } | { "type": "upsert_sequence", sequence: SequenceMsg, } | { "type": "remove_sequence", name: string, } | { "type": "define_signal", name: string, initial: boolean, } | { "type": "remove_signal", name: string, } | { "type": "simulate_sequence", name: string, scenario?: string | null, } | { "type": "simulate_sequences", names: Array<string>, scenario?: string | null, } | { "type": "export_usd", fps: number, } | { "type": "upsert_scenario", scenario: ScenarioMsg, } | { "type": "remove_scenario", name: string, } | { "type": "upsert_sensor", sensor: SensorMsg, } | { "type": "remove_sensor", name: string, } | { "type": "upsert_device", device: DeviceMsg, } | { "type": "remove_device", name: string, } | { "type": "upsert_camera", camera: CameraMsg, } | { "type": "remove_camera", name: string, } | { "type": "upsert_lidar", lidar: LidarMsg, } | { "type": "remove_lidar", name: string, } | { "type": "upsert_io_node", node: IoNode, } | { "type": "remove_io_node", name: string, } | { "type": "bind_io", binding: IoBinding, } | { "type": "unbind_io", point: IoPointId, node?: string | null, } | { "type": "declare_io", decl: IoDecl, } | { "type": "undeclare_io", name: string, } | { "type": "auto_assign_io", reassign: boolean, };
